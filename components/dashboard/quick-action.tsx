...
const actions = [
  {
    titleId: "Asisten AI",
    titleEn: "AI Debugger",
    descriptionId: "Analisis dan perbaiki kode secara instan.",
    descriptionEn: "Analyze and fix your code instantly.",
    href: "/ai-debugger",
    icon: Bug,
  },
  {
    titleId: "Prompt Gambar",
    titleEn: "Image Prompt",
    descriptionId: "Buat prompt untuk model gambar AI.",
    descriptionEn: "Generate prompts for AI image models.",
    href: "/image-prompt",
    icon: ImageIcon,
  },
  {
  ...
  {
    titleId: "Animasi AI",
    titleEn: "AI Animation",
    descriptionId: "Buat ide animasi dengan AI.",
  ...
  },
  {
    titleId: "Dokumen AI",
    titleEn: "AI Document",
    descriptionId: "Analisis dokumen PDF, DOCX, dan TXT.",
    descriptionEn: "Analyze PDF, DOCX, and TXT documents.",
    href: "/ai-document",
    icon: FileText,
  },
  {
    titleId: "Pengenal Teks",
    titleEn: "AI OCR",
    descriptionId: "Ekstrak dan analisis teks dari gambar.",
    descriptionEn: "Extract and analyze text from images.",
    href: "/ai-ocr",
    icon: ScanText,
  },
  {
    ...
    descriptionId: "Terjemahkan teks ke berbagai bahasa.",
    descriptionEn: "Translate text into multiple languages.",
    href: "/ai-translator",
    icon: Languages,
  },
];
